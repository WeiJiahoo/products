...
​	__注意：在Ubuntu环境中，波特率支持到115200,460800,921600，本例程使用的是115200。__

​		__如果需要输出帧率超过100Hz，则需要需要修改main.c函数中的options.c_cflag参数，改为更高的波特率。__

![](.\img\5.png)

​		__如图，在第83行，将B115200修改为B460800或者是B921600。__
